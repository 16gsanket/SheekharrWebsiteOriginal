      ...
      <div className=" mx-auto w-full">
        <div className="flex justify-between align-middle items-center">
          ...
          >
            ...
            >
              <Image
                src="https://res.cloudinary.com/dipc3ow9z/image/upload/v1751266540/thumbnail_Outlook-4fwodoo1-Picsart-AiImageEnhancer-Picsart-AiImageEnhancer_xjnidd.png"
                alt="logo"
                width={80}
                height={80}
              />
